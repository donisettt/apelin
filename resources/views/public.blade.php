...
<head>
    ...
    <!-- Favicons -->
    <link href="/bootstrap/assets/img/lgo.png" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="#">Laundry Dn</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto"><img src="/bootstrap/assets/img/logo.png" alt="" class="img-fluid"></a>-->
        ...
        <div class="container d-flex h-100">
          <div class="row justify-content-center align-self-center" data-aos="fade-up">
            <div class="col-lg-6 intro-info order-lg-first order-last" data-aos="zoom-in" data-aos-delay="100">
              <h2>Cape Kerja<br>Cucian Banyak <span>Laundry in Aja!</span></h2>
              <div>
            ...
            <div class="col-lg-6 intro-img order-lg-last order-first" data-aos="zoom-out" data-aos-delay="200">
              <img src="/bootstrap/assets/img/intro-img.svg" alt="" class="img-fluid">
            </div>
          </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img" data-aos="fade-right" data-aos-delay="100">
                            <img src="/bootstrap/assets/img/home.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="about-content" data-aos="fade-left" data-aos-delay="100">
                            <h2>Tentang Kami</h2>
                            <h3>Kepuasan pelanggan merupakan tujuan utama kami.</h3>
                            <p>Laundry Dn kini hadir diberbagai kota dengan memberikan pelayanan yang super express mejadikan pelanggan super puas. Segera kunjungi Laundry Dn dikota anda sekarang juga!.</p>
                            <ul>
                                <li><i class="bi bi-check-circle"></i> Pelayanan Kilat.</li>
                                <li><i class="bi bi-check-circle"></i> Tersedia berbagai macam paket.</li>
                                <li><i class="bi bi-check-circle"></i> Tidak hanya hadir dikota-kota besar tapi sudah mencapai hampir seluruh Indonesia.</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h3>Pelayanan</h3>
                    <p>Menjadikan pelanggan raja dan memberikan Kepuasan sepenuh hati</p>
                </header>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">Berbagai Paket</a></h4>
                            <p class="description text-center">Memberikan berbagai paket laundry kepada pelanggan dengan penuh kualitas internasional</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">Pelayanan Kilat</a></h4>
                    ...
                    <div class="col-md-6 col-lg-4 wow" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            <div class="icon" style="background: #eafde7;"><i class="bi bi-cart3"
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200"">
                        <div class=" box">
                            <div class="icon" style="background: #e1eeff;"><i class="bi bi-google-play"
                                    style="color: #2282ff;"></i></div>
                            <h4 class="title"><a href="">Tersedia Diberbagai IOS</a></h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="why-us-img">
                            <img src="/bootstrap/assets/img/why-us.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="why-us-content">
                            ...
                            <div class="features clearfix" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <p>Molestias eius rerum iusto voluptas et ab cupiditate aut enim. Assumenda animi
                                    occaecati. Quo dolore fuga quasi autem aliquid ipsum odit. Perferendis doloremque
                                    iure nulla aut.</p>
                            </div>
                            ...
                            <div class="features clearfix" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <p>Voluptates nihil et quis omnis et eaque omnis sint aut. Ducimus dolorum aspernatur.
                                    Totam dolores ut enim ullam voluptas distinctio aut.</p>
                            </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row feature-item">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                        <img src="/bootstrap//bootstrap/assets/img/features-1.svg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row feature-item mt-5 pt-5">
                    <div class="col-lg-6 wow fadeInUp order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="/bootstrap//bootstrap/assets/img/features-2.svg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/app1.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">App 1</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/app1.jpg" data-gallery="portfolioGallery"
                                        title="App 1" class="link-preview portfolio-lightbox"><i
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/web3.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Web 3</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/web3.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/app2.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">App 2</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/app2.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/card2.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Card 2</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/card2.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/web2.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Web 2</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/web2.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/app3.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">App 3</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/app3.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/card1.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Card 1</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/card1.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/card3.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Card 3</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/card3.jpg" class="link-preview portfolio-lightbox"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="/bootstrap/assets/img/portfolio/web1.jpg" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">Web 1</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="/bootstrap/assets/img/portfolio/web1.jpg" class="link-preview portfolio-lightbox"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="/bootstrap/assets/img/testimonial-1.jpg" class="testimonial-img"
                                            alt="">
                                        <h3>Saul Goodman</h3>
                                        <h4>Ceo &amp; Founder</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="/bootstrap/assets/img/testimonial-2.jpg" class="testimonial-img"
                                            alt="">
                                        <h3>Sara Wilsson</h3>
                                        <h4>Designer</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="/bootstrap/assets/img/testimonial-3.jpg" class="testimonial-img"
                                            alt="">
                                        <h3>Jena Karlis</h3>
                                        <h4>Store Owner</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="/bootstrap/assets/img/testimonial-4.jpg" class="testimonial-img"
                                            alt="">
                                        <h3>Matt Brandon</h3>
                                        <h4>Freelancer</h4>
                                        <p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <img src="/bootstrap/assets/img/team-1.jpg" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <img src="/bootstrap/assets/img/team-2.jpg" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                                    <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <img src="/bootstrap/assets/img/team-3.jpg" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="member">
                            <img src="/bootstrap/assets/img/team-4.jpg" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                                    <h4>Amanda Jepson</h4>
            ...
            <div class="container" data-aos="zoom-in">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-1.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-2.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-3.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-4.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-5.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-6.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-7.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="/bootstrap/assets/img/clients/client-8.png" class="img-fluid"
                                alt=""></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
